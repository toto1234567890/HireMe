...
class Order(Base):  # pylint: disable=too-few-public-methods
    ...
    def __init__(self, broker: String, ticker: String, asset_type: String, order_type: String, buy_or_sell: String, state: String, price: float, quantity: float, amount: float, order_date: datetime, user:String):
        self.broker = broker
        self.ticker = ticker
