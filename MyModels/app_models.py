...
############################################################################################################
#       Only to test with ./common/database.py otherwise app_models should be in related directories       #
############################################################################################################
...
AppSchema = declarative_base(cls=MyAppBase)
...
class AppBaseDemo(AppSchema):  # pylint: disable=too-few-public-methods
    __tablename__ = "app_base_demo"
